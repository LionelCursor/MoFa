...
public class AboutUsActivity extends SwipeBackActivity {
    ...
    private List<Map<String,Object>> getData(){
        ...
        mapApp.put("image", R.drawable.ic_launcher);
        ...
        mapChenGang.put("image",R.drawable.ic_launcher);
        ...
        mapLei.put("image",R.drawable.ic_launcher);
        ...
        mapLiuChange.put("image",R.drawable.ic_launcher);
