...
//        mofaList = new ArrayList<HashMap<String, Object>>();
    ...
    private void setRecommendedList() {
        ...
        recommendedList.add(map);
        map = new HashMap<String, Object>();
        map.put(KEY_SRC_DATA_PATH, Config.IMAGE_51);
        recommendedList.add(map);
        map = new HashMap<String, Object>();
        map.put(KEY_SRC_DATA_PATH, Config.IMAGE_52);
        recommendedList.add(map);
        map = new HashMap<String, Object>();
        map.put(KEY_SRC_DATA_PATH, Config.IMAGE_53);
        recommendedList.add(map);
        map = new HashMap<String, Object>();
        map.put(KEY_SRC_DATA_PATH, Config.IMAGE_54);
        recommendedList.add(map);
        map = new HashMap<String, Object>();
        map.put(KEY_SRC_DATA_PATH, Config.IMAGE_55);
        recommendedList.add(map);
        map = new HashMap<String, Object>();
        map.put(KEY_SRC_DATA_PATH, Config.IMAGE_56);
        recommendedList.add(map);
        map = new HashMap<String, Object>();
        map.put(KEY_SRC_DATA_PATH, Config.IMAGE_57);
        recommendedList.add(map);
        map = new HashMap<String, Object>();
        map.put(KEY_SRC_DATA_PATH, Config.IMAGE_58);
        recommendedList.add(map);
        map = new HashMap<String, Object>();
        map.put(KEY_SRC_DATA_PATH, Config.IMAGE_59);
        recommendedList.add(map);
        map = new HashMap<String, Object>();
