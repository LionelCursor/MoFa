...
/**
 * Created by ldx on 2014/12/4.
 */
public class MoFaSlidingDrawer extends ViewGroup {
     ...
     */
    public MoFaSlidingDrawer(Context context, AttributeSet attrs) {
     ...
     */
    public MoFaSlidingDrawer(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void onInitializeAccessibilityEvent(AccessibilityEvent event) {
        ...
        event.setClassName(MoFaSlidingDrawer.class.getName());
    }

    @Override
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info) {
        super.onInitializeAccessibilityNodeInfo(info);
        info.setClassName(MoFaSlidingDrawer.class.getName());
    }
